...
status: planned
status_note: "Part 2 (the policy) is unstarted; Part 1 split out to [0037](done/0037-row-origin-tagging.md). Part 3, the release sweep, was withdrawn on 2026-09-05 after its one run deleted real training data (recovery: [0053](done/0053-recover-swept-staging-rows.md)). Carried over from 2.0.0 to 2.1.0."
label: infra
depends: [37]
...
### Part 1 — Tell staging apart → [0037](done/0037-row-origin-tagging.md)
...
because it was the only part blocking anything — [0026](done/0026-signal-chrome-and-primitives.md)
waited on it.
...
[0053](done/0053-recover-swept-staging-rows.md). This part is withdrawn, and the
release procedure ([0050](0050-release-procedure.md)) no longer carries the step.
