---
title: Close the eight holes in the grounding gate
authors: [Peter Petrov]
created: 2026-08-26
last_updated: 2026-09-08
status: done
status_note: "seven wording edits applied to `SKILL.md` on 2026-09-08, plus four examples the app had since overtaken. §13.7's fork was postponed to 3.0.0 as [0065](../0065-rescale-exemption-unchecked-base.md); §13.8 was deliberately left alone."
label: infra
release: 2.1.0
---

# RFC 0015: Close the eight holes in the grounding gate

**The gate** is `/ground`
(`.claude/skills/ground/SKILL.md`) — the
...
read: `.claude/skills/ground/SKILL.md`,
...
Edit `.claude/skills/ground/SKILL.md` only.
...
- Any scout run. Applying these edits grounds nothing — the back-fill running
  order lives in [0009-feature-grounding.md](0009-feature-grounding.md) under pushback #7(b).
...
- [x] All seven wording edits are in `SKILL.md`. §13.7's fork is not chosen —
  it is postponed to 3.0.0 as [0065](../0065-rescale-exemption-unchecked-base.md),
...
> [0039](0039-adaptations-read-grounding.md) S11 grounded the rep bands and
...
> after it was written: [0039](0039-adaptations-read-grounding.md) S10 and S4
...
> **Split out and postponed 2026-09-08 → [0065](../0065-rescale-exemption-unchecked-base.md),
