---
title: Cross-adaptation set/rep classification — TBC
authors: [Peter Petrov]
created: 2026-07-07
last_updated: 2026-09-03
status: done
status_note: "decided and shipped inside [039 §6.0](0039-adaptations-read-grounding.md) (classifier v1.13.0, band edges v1.16.8, closed 2026-09-03): rep bands overlap and a set counts in full toward every quality whose band covers it (no fractional bleed, no weighting curve). Rows 2.1–2.3 and 2.6 are grounded there."
label: backlog
depends: [39]
---

# RFC 0001: Cross-adaptation set/rep classification — TBC
