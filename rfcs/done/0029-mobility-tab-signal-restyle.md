---
title: Mobility tab — SIGNAL restyle
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-08
status: done
status_note: form, stretch-volume card, chart and history are SIGNAL; landed 2026-09-01 in v1.8.0.
label: feature
depends: [26]
release: 2.0.0
---

# RFC 0029: Mobility tab — SIGNAL restyle
...
- [x] Log → history → edit path browser-verified with a screenshot; console
      ...
      predates this work ([0038](0038-favicon-and-app-icon.md)). The test
