---
title: "Docs link and anchor check — put the 036 checker in `scripts/`"
authors: [Peter Petrov]
created: 2026-09-05
last_updated: 2026-09-08
status: done
status_note: "2026-09-05, v1.18.3: `scripts/check-docs-links.mjs`, `npm run check:docs` and the README line shipped the same day the brief was filed, straight after [0036](0036-grounding-inventory-stale-refs.md) closed, because its acceptance check lived in a session scratchpad and was already gone."
label: infra
---

# RFC 0047: Docs link and anchor check — put the 036 checker in `scripts/`
...
[0023](0023-mechanical-code-quality-tooling.md): 023 is about code (ESLint,
...
3. **One line in [docs/rfcs/README.md](../README.md)**: run `npm run check:docs`
