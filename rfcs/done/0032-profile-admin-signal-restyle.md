---
title: "Profile & Admin — SIGNAL restyle"
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-05
status: done
status_note: shipped 2026-09-01 in v1.10.0 (Profile) and v1.11.0 (Admin); both tabs and every child pane browser-verified.
label: feature
depends: [26]
release: 2.0.0
---

# RFC 0032: Profile & Admin — SIGNAL restyle
...
[0033](0033-retire-old-design-language.md) cannot delete the old tokens until
they do.
...
- **Profile** — Monday/Sunday indigo toggle, adaptation-tracking chips,
  ...
  `src/components/layout/ExportPane.tsx` and
  `src/components/layout/ImportPane.tsx` — sit in
  `layout/` but are Profile surfaces, so [0026](0026-signal-chrome-and-primitives.md)
