---
title: The door from Home to Adaptations, and the four bars where they belong
authors: [Peter Petrov]
created: 2026-09-07
last_updated: 2026-09-07
status: done
status_note: "shipped 2026-09-07 (v2.0.42). Home's map card links to Adaptations, the muscle sheet carries its muscle across, and the four qualities read against their own window target through one resolver and one scaler."
label: feature
depends: [62]
release: 2.1.0
---

# RFC 0064: The door from Home to Adaptations, and the four bars where they belong

## The failure this prevents

[0062](0062-home-adaptations-one-screen.md) ruled that Home and Adaptations
...
5. **Does it write a number claiming physiological meaning?** No new number.
   ...
   already shipped and grounded ([0039](0039-adaptations-read-grounding.md)
...
**One resolver, one scaler.** [0063](0063-home-whole-body-strip-vs-line.md)
