---
title: Restore the Garmin sync (token regen + backfill)
authors: [Peter Petrov]
created: 2026-08-26
last_updated: 2026-09-01
status: done
status_note: "2026-08-27: the token was minted and the sync verified by Peter. The steps below are kept as the runbook for the next time the token dies."
label: infra
---

# RFC 0017: Restore the Garmin sync (token regen + backfill)
...
5. **Backfill** (this absorbs the Phase 1 remainder that used to live in
   [0008-garmin-recovery-load-axis.md](0008-garmin-recovery-load-axis.md)): the activity
   ...
   `.github/workflows/garmin-activity-sync.yml`
