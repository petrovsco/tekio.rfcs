---
title: "Garmin daily load & readiness → Recovery axis (Garmin sync Phase 2)"
authors: [Peter Petrov]
created: 2026-07-15
last_updated: 2026-09-01
status: discarded
status_note: "2026-09-01, Peter's call: the daily pull was never built, the surface it targeted is gone, and Home already answers \"can I push today?\" from sleep + HRV."
label: feature
---

# RFC 0008: Garmin daily load & readiness → Recovery axis (Garmin sync Phase 2)
...
[0017-garmin-sync-token-restore.md](0017-garmin-sync-token-restore.md).
...
- **Recovery axis** lived in `src/components/tabs/home/RecoveryCard.tsx` (deleted 2026-08-31).
  ...
  [0014-doctrine-ledger-execution.md](0014-doctrine-ledger-execution.md))
  and `RECOVERY_TARGETS` in `src/constants/app.ts`.
