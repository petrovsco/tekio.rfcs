---
title: Adaptations tab — the drill-down read
authors: [Peter Petrov]
created: 2026-09-02
last_updated: 2026-09-08
status: done
status_note: "shipped 2026-09-04 as v1.17.0 (units 1–5, v1.16.10 → v1.17.0): the Adaptations tab is a second Home on the rolling 14-day window. 033 unblocked."
label: feature
depends: [19, 26, 39]
release: 2.0.0
---

# RFC 0031: Adaptations tab — the drill-down read

## Progress log

- **2026-09-01** — written as "Adaptations tab — SIGNAL restyle", deliberately
  sequenced after [0019](0019-adaptation-model-simplification.md) so nine rows
  would not be restyled and then two deleted.
- **2026-09-01** — unblocked: 019 and [0026](0026-signal-chrome-and-primitives.md)
  both landed.
- **2026-09-02** — rescoped. Restyling the current composition would have
  ...
  [0039](0039-adaptations-read-grounding.md), which now gates this brief. The
  restyle is still in here — a rebuilt page is written in the SIGNAL language by
  construction, so [0033](0033-retire-old-design-language.md)'s dependency is
...
- **2026-09-04** — unit 5: final browser pass on the unit-4 code (console
  ...
  [0033](0033-retire-old-design-language.md) taken off `blocked`, and the
...
2. **MUSCLE COVERAGE · THIS WEEK earns nothing.** It restates Home's map in a
   third dialect (see [039 §1](0039-adaptations-read-grounding.md)) with no
...
denominated in is [0039](0039-adaptations-read-grounding.md)'s decision** — that is
...
[0005](0005-hr-zone-intensity-classification.md); do not build it on a duration
...
- **Classifier changes** — [0001](0001-cross-adaptation-rep-ranges.md)
  (retired — decided inside 039), [0005](0005-hr-zone-intensity-classification.md).
...
- [x] Browser-verified with a screenshot next to Home for comparison; console
      ...
      [0038](0038-favicon-and-app-icon.md)'s.
...
- **Unit 5 — verify and close.** Browser-verify against Home (headless
  ...
  tick §6; move to `done/`; then take [0033](0033-retire-old-design-language.md)
