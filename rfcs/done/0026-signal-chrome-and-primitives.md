---
title: SIGNAL chrome — tokens, shell, and shared primitives
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-05
status: done
status_note: "icon set, shell chrome, every `ui/` primitive, EditModal and the §Charts spec all landed 2026-09-01 in v1.5.0."
label: feature
depends: [37]
release: 2.0.0
---

# RFC 0026: SIGNAL chrome — tokens, shell, and shared primitives

**Origin:** 2026-09-01 screen survey. Home wears the SIGNAL language ([design-system.md](../../design-system.md), from roadmap [0018](0018-home-design-canvas.md)); every other surface — and the chrome *around* Home — still wears the v1 slate/indigo language.
...
[0037](0037-row-origin-tagging.md) makes those rows identifiable first. (037 was
024's Part 1 until 2026-09-01; the rest of 024 does not block this brief.)

## The gap

The two languages already coexist in
`src/index.css`: the SIGNAL tokens (`paper`, `ink`,
...
- Deleting the old tokens — [0033](0033-retire-old-design-language.md), once
...
- **ExportPane / ImportPane** live in `src/components/layout/` but are Profile
  surfaces, so they went to [0032](0032-profile-admin-signal-restyle.md) rather
