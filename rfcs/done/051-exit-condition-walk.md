...
**Label:** feature
**Status:** done — walked 2026-09-07. Two yeses, one miss: Home cannot name a missing muscle-linked quality, so §6 is **not yet met** and the austerity holds. The miss is [061](../061-home-names-missing-muscle-quality.md); the merge hypothesis it raised is [062](../062-home-adaptations-one-screen.md).
**Release:** 2.1.0
...
already uses. That is [061](../061-home-names-missing-muscle-quality.md).
