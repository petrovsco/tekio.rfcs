---
title: Cardio Progress chart — roll up by week and month in the long frames
authors: [Peter Petrov]
created: 2026-09-06
last_updated: 2026-09-06
status: done
status_note: "shipped 2026-09-06 (v2.0.21): `rollupCardio` + `grainForFrame` in utils.ts, the grain wired into CardioTab, checked in a browser at 390 px. The one gap found on the way (an isolated pace bucket draws no mark) is brief 056."
label: feature
---

# RFC 0055: Cardio Progress chart — roll up by week and month in the long frames
...
([0054](0054-garmin-history-backfill-cardio-hiit.md)) the chart holds
...
`src/lib/utils.ts` — `rollupCardio(sessions, grain,
weekStart)` returning the bucket rows above — with cases in
`src/test/utils.test.ts` for the sums, the
