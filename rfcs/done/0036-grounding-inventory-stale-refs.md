---
title: Grounding inventory — sweep stale references
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-05
status: done
status_note: "shipped 2026-09-05 (v1.18.1): 25 dead links fixed across `docs/`, §4 of the inventory re-indexed against `fusedRead.ts`, all 74 line anchors re-read."
label: bug
---

# RFC 0036: Grounding inventory — sweep stale references
...
fused Home shipped. Per [done/0014](0014-doctrine-ledger-execution.md),
...
- Rows 4.5, 4.10 and 7.3 are the Habits-side numbers — the adherence target,
  ...
  ([done/0035](0035-habits-expiry-deletion.md)), so they retire the same way
...
- Re-run the link check over `docs/` (extract every relative link target, `test -e`) and
  ...
  - `026` → `../0032-profile-admin-signal-restyle.md` (032 is in `done/` now)
...
- **Repoint the drifted `#L<n>` anchors.** Found 2026-09-01 while reindexing §1–§3
  for [0019](0019-adaptation-model-simplification.md): the anchors into
