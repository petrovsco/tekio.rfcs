---
title: Adaptations read — ground what the page shows
authors: [Peter Petrov]
created: 2026-09-02
last_updated: 2026-09-10
status: done
status_note: "closed 2026-09-03 (v1.16.9): the twelve scout blocks live in [grounding/0039-adaptations-read.md](../../grounding/039-adaptations-read.md#grounding), the code units shipped v1.13.0–v1.16.8, [0001](0001-cross-adaptation-rep-ranges.md) retired inside this brief and [0031](0031-adaptations-drill-down-read.md) set to `planned`."
label: feature
depends: [19]
release: 2.0.0
---

# RFC 0039: Adaptations read — ground what the page shows

**Covers inventory rows:** 2.1, 2.2, 2.3, 2.6, 3.3, 3.4, 3.6, 3.7, 3.8, 3.9, 3.10, 7.1, 7.4, 7.5 in [grounding-inventory.md](../../grounding-inventory.md), plus one number that has no row at all (`CYCLE_SET_TARGET`, replaced by `MUSCLE_WINDOW_DAYS` under §6.6).
...
- **2026-09-03** — S1's level-3 zeroing shipped via
  [done/0042](0042-level-3-link-audit.md) (v1.14.0). S12 + S4 blocks
  ...
  2.6 / 3.3 / 7.5, D15–D17. [done/0043](0043-scout-named-exercises-catalogue.md)
...
- **2026-09-03** — the nine landed blocks moved to
  [grounding/0039-adaptations-read.md](../../grounding/039-adaptations-read.md#grounding)
...
**This brief settles the meanings. [0031](0031-adaptations-drill-down-read.md)
...
| Adaptations tab, MUSCLE COVERAGE card | `muscleCoverage` (`src/lib/utils.ts`) | **week-to-date** | none — bars are relative to the busiest muscle | no |
...
grounded in [010 §Grounding](0010-home-fused-reads.md#grounding)). So Home's
...
| 3.3, 3.4, 3.6, 3.10 | Power / strength / muscular-endurance `rx` prose and `ADAPTATION_PRINCIPLE` | `cross-adaptation-rep-ranges` | [0001](0001-cross-adaptation-rep-ranges.md) is `backlog` and is about a *different* question — whether classification should be fuzzy |
| 3.7, 3.8, 3.9 | Anaerobic / VO₂max / endurance `rx` prose | `hr-zone-intensity-classification` | [0005](0005-hr-zone-intensity-classification.md) is about *classifier thresholds*, not the prescriptions the page prints |
...
3. **Repoint the inventory** in the same change — rows 3.3–3.10 and 7.1/7.4/7.5
   ...
   [0019](0019-adaptation-model-simplification.md) followed).
...
- **Cardio classifier thresholds** (rows 6.1–6.5, the ≥25/≥8 min heuristic, the
  TE cutoff) — [0005](0005-hr-zone-intensity-classification.md).
- **Any pixel of the redesign** — [0031](0031-adaptations-drill-down-read.md).
...
3. **Close:** tick §5, move this file to `done/` (the grounding file and the source
   comments stay put), move [0001](0001-cross-adaptation-rep-ranges.md) to `done/` as
   `done — decided and shipped inside 039`, repoint its links (031 §4, 034,
   the inventory), and set [0031](0031-adaptations-drill-down-read.md) to
