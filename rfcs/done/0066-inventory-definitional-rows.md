---
title: Mark the inventory rows that no research could ever settle
authors: [Peter Petrov]
created: 2026-09-08
last_updated: 2026-09-08
status: done
status_note: "all nine `unknown †` rows judged on 2026-09-08: five took `n/a — definitional`, four kept `unknown`, each with its one-line reason in the row. No value in the app moved."
label: infra
---

# RFC 0066: Mark the inventory rows that no research could ever settle
...
[0015](0015-ground-trigger-spec-fixes.md) §13.2 added the state that says so.
