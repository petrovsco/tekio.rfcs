---
title: "Adaptations \"on target\" — one threshold, shared with the map"
authors: [Peter Petrov]
created: 2026-09-04
last_updated: 2026-09-04
status: done
status_note: "the counter, the \"Short:\" line and the map callouts read `GAP_CUTOFF` over the leaves the map draws; three tests pin it and inventory row 7.5 matches (2026-09-04, v1.17.4)."
label: bug
---

# RFC 0045: Adaptations "on target" — one threshold, shared with the map
...
2. **The 0.70 gap cutoff.** `GAP_CUTOFF`, then in
   `src/components/tabs/home/GapMap.tsx`,
...
5. **Number claiming physiological meaning?** No new number. `GAP_CUTOFF`
   ...
   [docs/grounding/0039-adaptations-read.md](../../grounding/039-adaptations-read.md);
