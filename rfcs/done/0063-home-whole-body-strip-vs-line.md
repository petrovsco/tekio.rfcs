---
title: "Home's whole-body strip and its qualities line read one question two ways"
authors: [Peter Petrov]
created: 2026-09-07
last_updated: 2026-09-07
status: done
status_note: "shape 1 shipped 2026-09-07 (v2.0.40): one `coverageState` call spells both the chip and the line, so the two cannot disagree; `N d ago` stays as the note."
label: feature
---

# RFC 0063: Home's whole-body strip and its qualities line read one question two ways
