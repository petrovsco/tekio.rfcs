---
title: Row origin tagging — tell staging and dev rows apart
...
# RFC 0037: Row origin tagging — tell staging and dev rows apart
...
- **`habits` / `habit_completions`** — shelved by the doctrine ledger and
  deleted from the app on 2026-09-05 ([0035](0035-habits-expiry-deletion.md)); the
  table drops wait in [0025](0025-release-blocked-schema-drops.md). Do not add a
