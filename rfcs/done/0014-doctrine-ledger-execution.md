---
title: Execute the doctrine ledger — four folds and the Habits shelf
authors: [Peter Petrov]
created: 2026-08-26
last_updated: 2026-09-08
status: done
status_note: "2026-09-01. Folds, shelf and the readiness retirement all shipped (R1's cap met 2026-08-31, three menu sections, one slot free); the expiry remainder (`ExerciseMuscleEditor` move + Habits deletion) split out to 035 so this brief could close."
label: feature
depends: [10]
release: 2.0.0
---

# RFC 0014: Execute the doctrine ledger — four folds and the Habits shelf
...
Step 3 is blocked on [0010-home-fused-reads.md](0010-home-fused-reads.md) because
...
[0010-home-fused-reads.md](0010-home-fused-reads.md) §5 sets the order, and it exists to
...
1. **`ExerciseMuscleEditor.tsx` moves to Admin, it is not deleted.** It lives at
   ...
   next to `src/components/tabs/admin/MuscleGroupEditor.tsx`,
...
[0015-ground-trigger-spec-fixes.md](0015-ground-trigger-spec-fixes.md) §13.7 and is a
...
[010 §Grounding](0010-home-fused-reads.md#grounding).
...
- [x] `ExerciseMuscleEditor` is under Admin and the body map still renders.
  **Moved to [0035](0035-habits-expiry-deletion.md) (2026-09-01)** — it belonged
