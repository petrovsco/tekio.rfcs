---
title: Exercise name aliases — one movement, many spellings, one search
authors: [Peter Petrov]
created: 2026-09-07
last_updated: 2026-09-07
status: done
status_note: shipped 2026-09-07 (v2.0.44). 69 system aliases seeded, punctuation-insensitive matching, one resolver on every write path; verified in the browser and against the live database.
label: feature
release: 2.1.0
---

# RFC 0044: Exercise name aliases — one movement, many spellings, one search
...
`src/lib/exerciseName.ts` and the SQL function
...
- **Two write paths, one resolver.** `getOrCreateExercise` existed twice, in
  ...
  `src/lib/db/exercises.ts`. It returns the
...
- [x] The seed migration is in `supabase/migrations/` and the table is
      origin-tagged ([0037](0037-row-origin-tagging.md)), write-once
