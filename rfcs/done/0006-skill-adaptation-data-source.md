---
title: "Give the \"Skill\" adaptation a real data source (or retire it)"
authors: [Peter Petrov]
created: 2026-07-10
last_updated: 2026-09-01
status: done
status_note: "resolved 2026-08-29: option 3 (retire `skill`) chosen, as part of the nine → seven adaptation simplification. The code change it implies is [0019-adaptation-model-simplification.md](0019-adaptation-model-simplification.md)."
label: feature
---

# RFC 0006: Give the "Skill" adaptation a real data source (or retire it)
...
`src/lib/adaptations.ts`. Sport sessions used to be
