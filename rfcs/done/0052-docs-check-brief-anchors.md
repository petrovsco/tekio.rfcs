---
title: No line anchors in briefs
authors: [Peter Petrov]
created: 2026-09-05
last_updated: 2026-09-05
status: done
status_note: "Peter chose the \"forbid\" shape on 2026-09-05 and it shipped the same evening: `npm run check:docs` now fails on a `#L<n>` link in an active brief, and the 17 anchors that existed were rewritten to name the symbol."
label: infra
---

# RFC 0052: No line anchors in briefs
