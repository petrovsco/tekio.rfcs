---
title: Retire the v1 design language
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-04
status: done
status_note: closed 2026-09-04 (v1.17.3). The v1 tokens, their palette mirror and the chrome emoji are gone (v1.17.2); the conformance walk of every screen and sheet found nothing left to fix; bundle 551 kB against the 554 kB baseline.
label: infra
depends: [27, 28, 29, 30, 31, 32]
release: 2.0.0
---

# RFC 0033: Retire the v1 design language

[0026](0026-signal-chrome-and-primitives.md) promised the old tokens die when
...
1. **Delete the old tokens** from `src/index.css`:
