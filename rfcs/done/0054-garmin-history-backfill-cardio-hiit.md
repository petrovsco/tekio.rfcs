---
title: Garmin history backfill beyond sport — 157 cardio activities and 63 HIIT
authors: [Peter Petrov]
created: 2026-09-06
last_updated: 2026-09-10
status: done
status_note: "shipped 2026-09-06 in v2.0.15–v2.0.17: chart time frame, `format` + Custom, the sync's claim step and `hiit` map, and the backfill itself (220 rows back to 2023-05-13, the two manual runs claimed, a dry re-run reporting everything already synced). 005 now has the history as its evidence."
label: feature
---

# RFC 0054: Garmin history backfill beyond sport — 157 cardio activities and 63 HIIT
