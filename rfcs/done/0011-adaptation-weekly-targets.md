...
# RFC 0011: Adaptation weekly targets — grounding the numbers Home calls "missing"

**Kickoff:** this file is the brief. It exists to carry a grounding decision, not a feature.
**Origin:** run #7(b) of [0009-feature-grounding.md](0009-feature-grounding.md) — the first back-fill scout runs. Scope set by [grounding-inventory.md](../../grounding-inventory.md) §1 (rows 1.1–1.5, 1.7–1.9, 1.11) and §3.5, and by §13.9's ordering ("targets before weights").
...
[0010-home-fused-reads.md](0010-home-fused-reads.md) is the natural-looking home — the
...
**In:** the nine weekly targets in `src/constants/adaptations.ts`,
...
decision in [0006-skill-adaptation-data-source.md](0006-skill-adaptation-data-source.md),
...
[0010-home-fused-reads.md](0010-home-fused-reads.md).
