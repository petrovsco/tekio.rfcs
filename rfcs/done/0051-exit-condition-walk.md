---
title: The exit-condition walk — is the core perfected?
authors: [Peter Petrov]
created: 2026-09-07
last_updated: 2026-09-07
status: done
status_note: "walked 2026-09-07. Two yeses, one miss: Home cannot name a missing muscle-linked quality, so §6 is **not yet met** and the austerity holds. Both the miss and the merge hypothesis it raised now live in [0062](0062-home-adaptations-one-screen.md) — [0061](0061-home-names-missing-muscle-quality.md) was folded into it the same day."
label: feature
release: 2.1.0
---

# RFC 0051: The exit-condition walk — is the core perfected?

**Origin:** [doctrine.md](../../doctrine.md) §6: *"The core is perfected when: I open Home and, without tapping anything, know within five seconds which muscles are under-stimulated this cycle, which adaptations are untouched, and whether I'm recovered enough to push today. Until then, new sections don't get built and the shelf doesn't unshelve."* Home shipped ([0018](0018-home-design-canvas.md)), every surface is SIGNAL ([0033](0033-retire-old-design-language.md)), 2.0.0 is on production — and nobody has formally asked the question since it was written.
...
already uses. That was [0061](0061-home-names-missing-muscle-quality.md), which
Peter discarded into [0062](0062-home-adaptations-one-screen.md) later the
...
miss, so it got its own file: [0062](0062-home-adaptations-one-screen.md).
