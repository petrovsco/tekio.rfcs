---
title: Threshold sessions are labelled, not bucketed
authors: [Peter Petrov]
created: 2026-09-07
last_updated: 2026-09-07
status: done
status_note: "shipped 2026-09-07 (v2.0.36): A + B together, since 059/060 had already landed the HRmax the typed path divides by. The chip is on the session rows and the count is under the endurance band."
label: feature
---

# RFC 0057: Threshold sessions are labelled, not bucketed

## Why

Fork 1b in [0005](0005-hr-zone-intensity-classification.md) (2026-09-07) made
...
1. **Which read does this sharpen?** The Cardio session list and the endurance
   band on Adaptations — the effort-plane read [0031](0031-adaptations-drill-down-read.md) §3b
