---
title: Weights tab — SIGNAL restyle
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-08
status: done
status_note: the whole page, its plan banners and the progress chart are SIGNAL; landed 2026-09-01 in v1.6.0.
label: feature
depends: [26]
release: 2.0.0
---

# RFC 0027: Weights tab — SIGNAL restyle
...
- [x] Both program states browser-verified with screenshots; console clean apart
      ...
      ([0038](0038-favicon-and-app-icon.md)).
...
- **`BLOCK_META` still carries its emoji.** A SIGNAL `iconName` was added
  ...
  dies when [0030](0030-program-tab-signal-restyle.md) sweeps that page.
