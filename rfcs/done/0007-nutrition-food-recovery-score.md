---
title: Nutrition → Food Recovery Score (recovery-axis sub-project)
authors: [Peter Petrov]
created: 2026-07-14
last_updated: 2026-09-01
status: discarded
status_note: "2026-09-01, Peter's call: phase 2 was never committed to and the surface it targeted is gone. Phase 1's model is kept below as the record, not as work."
label: feature
---

# RFC 0007: Nutrition → Food Recovery Score (recovery-axis sub-project)

**Origin:** 2026-07-14, spun out of the recovery-axis food/nutrition follow-up ([0002-recovery-axis.md](0002-recovery-axis.md)) once the user specified a full scoring model. This is the "its own sub-project" the recovery axis deferred.
