---
title: HRmax for any user — a birth-date default, a tracker peak on acceptance
authors: [Peter Petrov]
created: 2026-09-07
last_updated: 2026-09-10
status: done
status_note: "shipped 2026-09-07 (v2.0.35), the evening [0059](0059-profile-hrmax-typed-hr-path.md) shipped and Peter said \"this is built only for me\". He picked the forks (A: Profile plus a hint on the cardio form; B: one number plus a source; C: propose again every time); the Tanaka estimate is the default from a birth date, the tracker's 196 is offered on his Profile and nothing is stored until he accepts or types."
label: feature
release: 2.1.0
---

# RFC 0060: HRmax for any user — a birth-date default, a tracker peak on acceptance
...
- Reading a typed HR on `intervals` rows; Garmin zones — 059's out-of-scope
  stands.
- The threshold label — [0057](0057-threshold-sessions-labelled.md).
