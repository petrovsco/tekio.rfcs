---
title: Garmin sync for sport activities (tennis, padel, …)
authors: [Peter Petrov]
created: 2026-09-02
last_updated: 2026-09-10
status: done
status_note: shipped (v2.0.8–2.0.10) and backfilled on 2026-09-06; Peter rated both 2026 matches the same day (quality 5 and 4, both wins) and the rows kept their Garmin source, which closes the round trip.
label: feature
release: 2.1.0
---

# RFC 0041: Garmin sync for sport activities (tennis, padel, …)
...
[0014](0014-doctrine-ledger-execution.md),
[0009](0009-feature-grounding.md), [0018](0018-home-design-canvas.md#out-of-scope),
[0028](0028-cardio-tab-signal-restyle.md#out-of-scope) — that item is about unifying
...
- `cardio_sessions.source` (`'manual' | 'garmin'`), `garmin_activity_id`, and a
  ...
  `supabase/migrations/20260713193142_cardio_garmin_activity_fields.sql`.
