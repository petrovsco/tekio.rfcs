---
title: Program tab — SIGNAL restyle
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-08
status: done
status_note: "all three states, the block-type icons and the emoji `BLOCK_META.icon` field landed 2026-09-01 in v1.9.0."
label: feature
depends: [26]
release: 2.0.0
---

# RFC 0030: Program tab — SIGNAL restyle
...
**Inherited from [0027](0027-weights-tab-signal-restyle.md):** `BLOCK_META`
in `src/constants/program.ts` now carries a
...
- Splitting the 840-line component — that is refactoring, tracked by the
  tooling in [0023](0023-mechanical-code-quality-tooling.md)'s output, not by
  a restyle.
...
- [x] All three states browser-verified with screenshots; console clean apart
      ...
      ([0038](0038-favicon-and-app-icon.md)). The empty state, the editor (day →
...
- [x] Drag-and-drop reordering still works — vacuously: **ProgramTab has no
      ...
      `ProfileTab`, so the check belongs to [0032](0032-profile-admin-signal-restyle.md).
