---
title: The first-paint baseline is 3 kB stale
authors: [Peter Petrov]
created: 2026-09-08
last_updated: 2026-09-08
status: done
status_note: "folded into v2.0.82 ([0048](0048-simplification-candidates.md) candidate A9), the next commit that moved the number, exactly as this brief asked, which took the baseline 352.47 kB → 348.69 kB. A7 moved it again the same day; the committed figure is 346.98 kB (v2.0.83)."
label: infra
---

# RFC 0068: The first-paint baseline is 3 kB stale
...
[048 A1](0048-simplification-candidates.md), where sharing a constant across two
