---
title: Cardio tab — SIGNAL restyle
authors: [Peter Petrov]
created: 2026-09-01
last_updated: 2026-09-07
status: done
status_note: both capture modes, both charts and the merged session list are SIGNAL; landed 2026-09-01 in v1.7.0.
label: feature
depends: [26]
release: 2.0.0
---

# RFC 0028: Cardio tab — SIGNAL restyle
...
- Classification changes (HR zones are [0005](0005-hr-zone-intensity-classification.md)).
