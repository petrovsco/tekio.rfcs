---
title: Pace dots on the rolled-up Cardio Progress frames
authors: [Peter Petrov]
created: 2026-09-06
last_updated: 2026-09-06
status: done
status_note: "shipped 2026-09-06 (v2.0.22): `hasLonePace` in utils.ts, `LoneDot` on the pace line in CardioTab for the week and month grains, §9 amended. Checked at 390 px: the two lone weeks in *This year* (Running) and the two lone months in *All time* (Cycling) draw a dot, joined points and the per-session frames none."
label: feature
---

# RFC 0056: Pace dots on the rolled-up Cardio Progress frames
...
[0055](0055-cardio-progress-rollup.md)'s browser check: the pace line
