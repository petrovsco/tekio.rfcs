---
title: Simplify the adaptation model — nine → seven
authors: [Peter Petrov]
created: 2026-08-29
last_updated: 2026-09-05
status: done
status_note: shipped 2026-09-01. Seven adaptations in the type, the constants, the dashboard, the guide and the targets editor; grounding inventory reindexed; 001, 012, 020 and 031 unblocked.
label: feature
release: 2.0.0
---

# RFC 0019: Simplify the adaptation model — nine → seven
...
- **Skill — drop for now.** "Very broad… hard to track by an app." The
  ...
  [0020-skill-recommendations-per-exercise.md](../0020-skill-recommendations-per-exercise.md)
  (backlog).
