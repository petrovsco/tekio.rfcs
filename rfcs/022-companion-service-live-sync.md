...
**Label:** backlog
**Status:** proposed 2026-08-30 (by a the personal knowledge base session, at Peter's direction) — parked until scoped against doctrine §4 in a tekio session; tekio-the-product has not committed to it yet.
