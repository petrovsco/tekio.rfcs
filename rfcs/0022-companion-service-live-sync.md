---
title: Companion service — live session sync/notifications
authors: [Peter Petrov]
created: 2026-08-30
last_updated: 2026-09-10
status: backlog
status_note: raised 2026-08-30. Parked until it is scoped against doctrine section 4 — the product has not committed to it yet. Left in backlog at the 2.1.0 planning (2026-09-05).
label: backlog
---

# RFC 0022: Companion service — live session sync/notifications
